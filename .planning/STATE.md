...
- [Phase 08]: Skip purchase records in seed (requires real Stripe session IDs); view/follower counts sufficient for demo
- [Phase 08]: Individual Mux assets per episode even with same placeholder source for realistic cleanup and management
