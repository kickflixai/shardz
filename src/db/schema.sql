...
-- ============================================================================
-- WAITLIST (Migration 00000000000006)
-- ============================================================================
...
-- ============================================================================
-- SOCIAL ENGAGEMENT (Migration 00000000000007)
-- ============================================================================
...
CREATE POLICY "Episode comments are readable by everyone"
  ON public.episode_comments FOR SELECT USING (true);
...
-- Profiles: watch history visibility
ALTER TABLE public.profiles
